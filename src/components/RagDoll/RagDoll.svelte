<script lang="ts">
	...
	import { Euler, Vector3, SphereGeometry, MeshStandardMaterial } from 'three'
	import { T, useFrame, useThrelte } from '@threlte/core'
	import { RigidBody, CollisionGroups, Collider } from '@threlte/rapier'
  import { GLTF, useGltfAnimations } from '@threlte/extras'

	import Controller from '$components/+utils/CameraControls/Controls.svelte'
	 ...
	 * @param duration
	 */
	function transitionTo(newAction: 'run'|'idle', duration = 1) {
